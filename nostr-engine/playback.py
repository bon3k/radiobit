        ...
        while True:
            ...
            if entrada == "abajo":
                ...
                if seleccion == 0:
                    ...
                    await self.menu_mensaje(leer_entrada)
                    break
...
#                break
    ...
    async def menu_mensaje(self, leer_entrada):
        ...
        while True:
            await self.mostrar_menu_async(opciones, seleccion, titulo="NOSTR-MSG")
            entrada = await leer_entrada()
...
#                break
    ...
    async def menu_publish(self, leer_entrada):
        ...
        img = self.lcd_interface.draw_text_on_lcd("Push to record")
        self.lcd_interface.display_image(img)
...
#        self.refresh_display()
    ...
    async def start_recording(self):
        ...
        self.recording_process = await asyncio.create_subprocess_exec(*cmd)
...
#            "-l", "es",
    ...
    async def publish_voice(self):
        ...
        # Ejecuta el binario de forma asincrónica y captura salida
    ...
    def reset_msg_state(self):
        ...
        try:
            os.remove("/tmp/radiobit_voice.wav")
        except:
            pass

        try:
            os.remove("/tmp/radiobit_voice.wav.txt")
        except:
            pass
